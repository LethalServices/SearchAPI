...
def logs(port):
    ...
    print(f'\n9anime:')
    print(f'-• [{Fore.GREEN}Info{Fore.WHITE}] {Fore.LIGHTYELLOW_EX}Simple Search{Fore.WHITE}: http://127.0.0.1:{port}/api/9anime?search=anime')
    print(f'-• [{Fore.GREEN}Info{Fore.WHITE}] {Fore.LIGHTYELLOW_EX}Advanced Search{Fore.WHITE}: http://127.0.0.1:{port}/api/9anime?search=anime&page=1')
